...
class ParishDetailScreen extends StatelessWidget {
  ...
  Widget _buildCoordinatorInfo(Parish parish) {
    return Column(
      ...
      children: [
        ...
        Text(
          "Last Visited: 5 months ago", // Example, replace with actual data
  ...
  Widget _buildGroupCard(Group group) {
    return Card(
      ...
      child: ListTile(
        leading: Icon(Icons.groups, color: kfBlue),
        title: Text(
          group.name,
          style: const TextStyle(
            fontSize: 16,
        ...
        onTap: () {
          // Navigate to a detailed group screen if needed
          // Get.toNamed('/groupDetail', arguments: group);
        },
      ),
    );
  }
